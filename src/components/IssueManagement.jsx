            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      {issue.assignedTo && (
                        <Badge variant="secondary">
                          Assigned to {typeof issue.assignedTo === 'string' ? issue.assignedTo : issue.assignedTo.name}
                        </Badge>
                      )}
                    </div>

                    <div className="text-xs text-gray-500">
                      Reported by {issue.reportedBy?.name || 'Unknown'} • {format(new Date(issue.createdAt), 'MMM d, yyyy HH:mm')}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 pt-3 border-t">
                  ...
                  <Select onValueChange={(value) => handlePriorityUpdate(issue.id, value)}>
                    <SelectTrigger className="w-40">
