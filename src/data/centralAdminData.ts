...
export const centralAdminUsers: User[] = [
  {
    id: 'central-admin-1',
...
export const centralAdminDepartments: Department[] = [
  {
    id: '1',
    name: 'Public Works',
...
export const centralAdminIssues: Issue[] = [
  {
    id: '1',
...
export const centralAdminAnalytics: Analytics = {
  totalReports: 156,
  resolvedReports: 89,
  totalIssues: 156,
  resolvedIssues: 89,
